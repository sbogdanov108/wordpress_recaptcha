...
function twentyseventeen_scripts() {
  ...
  // Bootstrap
  wp_enqueue_style('bootstrap', 'https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css', array('twentyseventeen-fonts'));
  
	// Theme stylesheet.
	wp_enqueue_style( 'twentyseventeen-style', get_stylesheet_uri(), array('bootstrap') );
...
/**
 * Подключение стилей, которые требуют в <link> атрибуты integrity и crossorign
 * @param $tag
 * @param $handle
 * @param $src
 *
 * @return string
 */
function my_special_styles($tag, $handle, $src) {
  if($handle === 'bootstrap')
    return '<link rel="stylesheet" href="' . $src . '" integrity="sha384-BVYiiSIFeK1dGmJRAkycuHAHRg32OmUcww7on3RYdg4Va+PmSTsz/K68vbdEjh4u" crossorigin="anonymous">' . "\n";
